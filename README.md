...
[![Travis](https://img.shields.io/travis/larsvanbraam/tracking-manager.svg?maxAge=2592000)](https://travis-ci.org/larsvanbraam/tracking-manager)
[![Code Climate](https://img.shields.io/codeclimate/github/larsvanbraam/tracking-manager.svg?maxAge=2592000)](https://codeclimate.com/github/larsvanbraam/tracking-manager)
[![Coveralls](https://img.shields.io/coveralls/larsvanbraam/tracking-manager.svg?maxAge=2592000)](https://coveralls.io/github/larsvanbraam/tracking-manager?branch=master)
[![npm](https://img.shields.io/npm/v/tracking-manager.svg?maxAge=2592000)](https://www.npmjs.com/package/tracking-manager)
[![npm](https://img.shields.io/npm/dm/tracking-manager.svg?maxAge=2592000)](https://www.npmjs.com/package/tracking-manager)
...
```sh
npm i -S tracking-manager
```

## Documentation

### TypeDoc
- [Latest TypeDoc](https://larsvanbraam.github.io/tracking-manager/docs/)
...
- `git clone https://github.com/larsvanbraam/tracking-manager.git`
- `cd tracking-manager/example`
- `yarn`
- `yarn dev`
- Open your browser `localhost:8080`

or click [this link](https://larsvanbraam.github.io/tracking-manager/example/) to preview online

## Building

In order to build tracking-manager, ensure that you have [Git](http://git-scm.com/downloads)
...
Change to the tracking-manager directory:
```sh
cd tracking-manager
```
